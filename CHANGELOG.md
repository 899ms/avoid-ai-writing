...
- Preserve Markdown structure and document content during corpus measurement. Separate structural cleanup from paragraph selection, retain eligible 400-word bodies after headings, and account for oversized units without silently deleting text. Measurement now rejects cached sources that differ from their recorded hashes (#178, #179, #180, #288, #289).
